    ...
    b.$uid = 0,
        function() {
            r.implement(this, d), this.$initOperationListeners = function() {
            	...
            	$('#console').html('>Compiling...');
                var valuee = this.session.getValue();

                //syntaxic translation and compile

                //if code is good
                setTimeout( (function(){ $('#console').html("><i class='green'>Compiled with 0 errors</i>") }), 3000);

                //if code is bad
                //setTimeout( (function(){ $('#console').html("><i class='red'>Synthax error...</i>") }), 3000);
